...
namespace DevBot.Homie {
    public class HostParameterProperty : INotifyPropertyChanged {
        ...
        internal HostParameterProperty(string topicPrefix, string propertyId, string friendlyName, DataType dataType, string unit) {
        ...
        internal void Initialize(IBroker broker) {
            ...
            _broker.Subscribe($"{_valueTopic}/set", (topic, value) => {
                SetValue(value);
